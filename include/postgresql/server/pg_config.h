...
#define CONFIGURE_ARGS " '--prefix=/opt/PostgreSQL/build' '--without-readline' '--without-zlib' '--prefix=/home/lucasmull/Trabalho/libpg/' 'CFLAGS=-m32' 'LDFLAGS=-m32' 'CXXFLAGS=-m32'"
